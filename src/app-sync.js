...
window.TRACE_EXTRA = (api) => {
  ...
  function pairPanel() {
    openPanel('pair our phones', (body) => {
      ...
      const nameRow = el('<input placeholder="your name" style="width:100%;padding:12px 14px;border-radius:14px;border:1px solid rgba(255,255,255,.14);background:rgba(255,255,255,.06);color:#f3f0f4;font:14px system-ui;outline:none">');
      ...
      body.appendChild(el(`<div style="text-align:center;padding:6px 0 0">
        <div style="font:700 10px ui-monospace,monospace;letter-spacing:.16em;color:rgba(243,240,244,.45)">YOUR CODE</div>
        <div style="font:700 44px ui-monospace,monospace;letter-spacing:.3em;color:#f4c66b;padding-left:.3em">${code}</div></div>`));

      const codeIn = el('<input placeholder="or type their code" maxlength="5" style="width:100%;padding:12px 14px;border-radius:14px;border:1px solid rgba(255,255,255,.14);background:rgba(255,255,255,.06);color:#f3f0f4;font:700 16px ui-monospace,monospace;letter-spacing:.2em;text-align:center;outline:none;text-transform:lowercase">');
