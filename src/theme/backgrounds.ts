...
/** Picker groupings — 60+ skies in one list is a scroll, four tabs is a choice. */
export type BackgroundFamily = 'calm' | 'scenes' | 'duotone' | 'faded';

export const FAMILY_ORDER: BackgroundFamily[] = ['calm', 'scenes', 'duotone', 'faded'];
export const FAMILY_LABELS: Record<BackgroundFamily, string> = {
  calm: 'Calm',
  scenes: 'Scenes',
  duotone: 'Duotone',
  faded: 'Faded',
...
export interface BackgroundPreset {
  key: string;
  label: string;
  /** Which picker tab this sky lives under. */
